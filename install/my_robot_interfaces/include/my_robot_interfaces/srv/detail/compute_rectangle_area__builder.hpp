...
{
public:
  explicit Init_ComputeRectangleArea_Request_length(::my_robot_interfaces::srv::ComputeRectangleArea_Request & msg)
  : msg_(msg)
  {}
  ::my_robot_interfaces::srv::ComputeRectangleArea_Request length(::my_robot_interfaces::srv::ComputeRectangleArea_Request::_length_type arg)
  {
...
public:
  ...
  {}
  Init_ComputeRectangleArea_Request_length width(::my_robot_interfaces::srv::ComputeRectangleArea_Request::_width_type arg)
  {
    msg_.width = std::move(arg);
    return Init_ComputeRectangleArea_Request_length(msg_);
  }
...
{
  return my_robot_interfaces::srv::builder::Init_ComputeRectangleArea_Request_width();
}
