...
static size_t _ComputeRectangleArea_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_my_robot_interfaces__srv__ComputeRectangleArea_Request(
    full_bounded, 0);
}
...
static size_t _ComputeRectangleArea_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_my_robot_interfaces__srv__ComputeRectangleArea_Response(
    full_bounded, 0);
}
