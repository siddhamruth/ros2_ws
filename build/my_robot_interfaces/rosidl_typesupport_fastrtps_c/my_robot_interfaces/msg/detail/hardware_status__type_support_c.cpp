...
#include "rosidl_runtime_c/string.h"  // debug_msg
#include "rosidl_runtime_c/string_functions.h"  // debug_msg
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->debug_msg;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: debug_msg
  {
    ...
    if (!ros_message->debug_msg.data) {
      rosidl_runtime_c__String__init(&ros_message->debug_msg);
    }
...
static size_t _HardwareStatus__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_my_robot_interfaces__msg__HardwareStatus(
    full_bounded, 0);
}
