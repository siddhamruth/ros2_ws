...
bool my_robot_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // temprature
    ...
    ros_message->temprature = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // are_motors_ready
  ...
  {  // debug_msg
    ...
    rosidl_runtime_c__String__assign(&ros_message->debug_msg, PyBytes_AS_STRING(encoded_field));
...
PyObject * my_robot_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // temprature
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->temprature);
    {
