...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.temprature = kwargs.get('temprature', int())
    ...
    def temprature(self, value):
        if __debug__:
            assert \
                ...
                "The 'temprature' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'temprature' field must be an integer in [-9223372036854775808, 9223372036854775807]"
