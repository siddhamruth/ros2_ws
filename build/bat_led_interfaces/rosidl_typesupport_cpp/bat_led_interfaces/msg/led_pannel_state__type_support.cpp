...
static const _LedPannelState_type_support_symbol_names_t _LedPannelState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bat_led_interfaces, msg, LedPannelState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bat_led_interfaces, msg, LedPannelState)),
  }
};
...
{
  return &::bat_led_interfaces::msg::rosidl_typesupport_cpp::LedPannelState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bat_led_interfaces, msg, LedPannelState)() {
  return get_message_type_support_handle<bat_led_interfaces::msg::LedPannelState>();
}
