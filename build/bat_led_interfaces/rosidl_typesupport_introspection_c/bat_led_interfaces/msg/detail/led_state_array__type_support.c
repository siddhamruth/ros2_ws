...
#include <stddef.h>
#include "bat_led_interfaces/msg/detail/led_state_array__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  bat_led_interfaces__msg__LedStateArray__init(message_memory);
}

void LedStateArray__rosidl_typesupport_introspection_c__LedStateArray_fini_function(void * message_memory)
{
  bat_led_interfaces__msg__LedStateArray__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember LedStateArray__rosidl_typesupport_introspection_c__LedStateArray_message_member_array[1] = {
  {
    ...
    offsetof(bat_led_interfaces__msg__LedStateArray, led_states),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers LedStateArray__rosidl_typesupport_introspection_c__LedStateArray_message_members = {
  ...
  1,  // number of fields
  sizeof(bat_led_interfaces__msg__LedStateArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bat_led_interfaces, msg, LedStateArray)() {
