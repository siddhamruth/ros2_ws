...
#include <stddef.h>
#include "bat_led_interfaces/srv/detail/set_led__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  bat_led_interfaces__srv__SetLed_Request__init(message_memory);
}

void SetLed_Request__rosidl_typesupport_introspection_c__SetLed_Request_fini_function(void * message_memory)
{
  bat_led_interfaces__srv__SetLed_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetLed_Request__rosidl_typesupport_introspection_c__SetLed_Request_message_member_array[2] = {
  {
    ...
    offsetof(bat_led_interfaces__srv__SetLed_Request, led_number),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bat_led_interfaces__srv__SetLed_Request, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetLed_Request__rosidl_typesupport_introspection_c__SetLed_Request_message_members = {
  "bat_led_interfaces__srv",  // message namespace
  "SetLed_Request",  // message name
  2,  // number of fields
  sizeof(bat_led_interfaces__srv__SetLed_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bat_led_interfaces, srv, SetLed_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  bat_led_interfaces__srv__SetLed_Response__init(message_memory);
}

void SetLed_Response__rosidl_typesupport_introspection_c__SetLed_Response_fini_function(void * message_memory)
{
  bat_led_interfaces__srv__SetLed_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetLed_Response__rosidl_typesupport_introspection_c__SetLed_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bat_led_interfaces__srv__SetLed_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetLed_Response__rosidl_typesupport_introspection_c__SetLed_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(bat_led_interfaces__srv__SetLed_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_bat_led_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bat_led_interfaces, srv, SetLed_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_service_members = {
  "bat_led_interfaces__srv",  // service namespace
  "SetLed",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_Request_message_type_support_handle,
  NULL  // response message
  // bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_Response_message_type_support_handle
};

static rosidl_service_type_support_t bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_service_type_support_handle = {
  0,
  &bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bat_led_interfaces, srv, SetLed)() {
  if (!bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_service_type_support_handle.typesupport_identifier) {
    bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bat_led_interfaces, srv, SetLed_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bat_led_interfaces, srv, SetLed_Response)()->data;
  }

  return &bat_led_interfaces__srv__detail__set_led__rosidl_typesupport_introspection_c__SetLed_service_type_support_handle;
}
