  ...
  map_msgs__srv__GetPointMapROI_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    map_msgs__srv__GetPointMapROI_Request * data =
      (map_msgs__srv__GetPointMapROI_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!map_msgs__srv__GetPointMapROI_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          map_msgs__srv__GetPointMapROI_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  map_msgs__srv__GetPointMapROI_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    map_msgs__srv__GetPointMapROI_Response * data =
      (map_msgs__srv__GetPointMapROI_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!map_msgs__srv__GetPointMapROI_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          map_msgs__srv__GetPointMapROI_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
