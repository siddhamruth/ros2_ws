...
#include "tutorial_interfaces_cpp/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_c.h"
...
#include "tutorial_interfaces_cpp/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _AddThreeInts_Request__ros_msg_type = tutorial_interfaces_cpp__srv__AddThreeInts_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tutorial_interfaces_cpp
...
static size_t _AddThreeInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces_cpp__srv__AddThreeInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces_cpp, srv, AddThreeInts_Request)() {
...
using _AddThreeInts_Response__ros_msg_type = tutorial_interfaces_cpp__srv__AddThreeInts_Response;
...
static size_t _AddThreeInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces_cpp__srv__AddThreeInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces_cpp, srv, AddThreeInts_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tutorial_interfaces_cpp, srv, AddThreeInts)() {
