...
class Metaclass_AddThreeInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tutorial_interfaces_cpp')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'tutorial_interfaces_cpp.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from tutorial_interfaces_cpp.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from tutorial_interfaces_cpp.srv._add_three_ints import AddThreeInts_Request as Request
    from tutorial_interfaces_cpp.srv._add_three_ints import AddThreeInts_Response as Response
