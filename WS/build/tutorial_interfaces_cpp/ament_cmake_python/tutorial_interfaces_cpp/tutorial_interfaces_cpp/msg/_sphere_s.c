...
bool tutorial_interfaces_cpp__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces_cpp.msg._sphere.Sphere", full_classname_dest, 42) == 0);
  }
  tutorial_interfaces_cpp__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * tutorial_interfaces_cpp__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tutorial_interfaces_cpp.msg._sphere");
