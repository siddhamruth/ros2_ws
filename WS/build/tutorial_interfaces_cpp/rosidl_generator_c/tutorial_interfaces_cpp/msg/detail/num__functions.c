...
tutorial_interfaces_cpp__msg__Num__create()
{
  ...
  tutorial_interfaces_cpp__msg__Num * msg = (tutorial_interfaces_cpp__msg__Num *)allocator.allocate(sizeof(tutorial_interfaces_cpp__msg__Num), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(tutorial_interfaces_cpp__msg__Num));
  bool success = tutorial_interfaces_cpp__msg__Num__init(msg);
  if (!success) {
...
tutorial_interfaces_cpp__msg__Num__destroy(tutorial_interfaces_cpp__msg__Num * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    tutorial_interfaces_cpp__msg__Num__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
tutorial_interfaces_cpp__msg__Num__Sequence__init(tutorial_interfaces_cpp__msg__Num__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces_cpp__msg__Num * data = NULL;

  if (size) {
    data = (tutorial_interfaces_cpp__msg__Num *)allocator.zero_allocate(size, sizeof(tutorial_interfaces_cpp__msg__Num), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = tutorial_interfaces_cpp__msg__Num__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        tutorial_interfaces_cpp__msg__Num__fini(&data[i - 1]);
      }
...
tutorial_interfaces_cpp__msg__Num__Sequence__fini(tutorial_interfaces_cpp__msg__Num__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      tutorial_interfaces_cpp__msg__Num__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  tutorial_interfaces_cpp__msg__Num__Sequence * array = (tutorial_interfaces_cpp__msg__Num__Sequence *)allocator.allocate(sizeof(tutorial_interfaces_cpp__msg__Num__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = tutorial_interfaces_cpp__msg__Num__Sequence__init(array, size);
  if (!success) {
...
tutorial_interfaces_cpp__msg__Num__Sequence__destroy(tutorial_interfaces_cpp__msg__Num__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    tutorial_interfaces_cpp__msg__Num__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
tutorial_interfaces_cpp__msg__Num__Sequence__are_equal(const tutorial_interfaces_cpp__msg__Num__Sequence * lhs, const tutorial_interfaces_cpp__msg__Num__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!tutorial_interfaces_cpp__msg__Num__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  tutorial_interfaces_cpp__msg__Num__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(tutorial_interfaces_cpp__msg__Num);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    tutorial_interfaces_cpp__msg__Num * data =
      (tutorial_interfaces_cpp__msg__Num *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!tutorial_interfaces_cpp__msg__Num__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          tutorial_interfaces_cpp__msg__Num__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!tutorial_interfaces_cpp__msg__Num__copy(
