...
#include "turtlesim/srv/detail/spawn__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Spawn_Request__get_serialized_size_with_initial_alignment(
...
{
  bool full_bounded;
  return max_serialized_size_Spawn_Request(&full_bounded, 0);
}
...
static message_type_support_callbacks_t _Spawn_Request__callbacks = {
  ...
  _Spawn_Request__get_serialized_size_with_initial_alignment,
...
{
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_Spawn_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, turtlesim, srv, Spawn_Request)() {
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_Spawn_Request__handle;
}
...
static size_t _Spawn_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const turtlesim::srv::Spawn_Response *>(
...
{
  bool full_bounded;
  return max_serialized_size_Spawn_Response(&full_bounded, 0);
}
...
static message_type_support_callbacks_t _Spawn_Response__callbacks = {
  ...
  _Spawn_Response__get_serialized_size_with_initial_alignment,
...
{
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_Spawn_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, turtlesim, srv, Spawn_Response)() {
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_Spawn_Response__handle;
}
...
{
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_Spawn__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, turtlesim, srv, Spawn)() {
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_Spawn__handle;
}
