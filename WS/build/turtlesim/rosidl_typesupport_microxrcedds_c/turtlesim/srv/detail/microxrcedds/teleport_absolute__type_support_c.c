...
#include "turtlesim/srv/detail/teleport_absolute__rosidl_typesupport_microxrcedds_c.h"
...
typedef turtlesim__srv__TeleportAbsolute_Request _TeleportAbsolute_Request__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _TeleportAbsolute_Request__ros_msg_type * ros_message = (_TeleportAbsolute_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _TeleportAbsolute_Request__ros_msg_type * ros_message = (const _TeleportAbsolute_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _TeleportAbsolute_Request__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_turtlesim__srv__TeleportAbsolute_Request(&full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, turtlesim, srv, TeleportAbsolute_Request)() {
...
typedef turtlesim__srv__TeleportAbsolute_Response _TeleportAbsolute_Response__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _TeleportAbsolute_Response__ros_msg_type * ros_message = (_TeleportAbsolute_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _TeleportAbsolute_Response__ros_msg_type * ros_message = (const _TeleportAbsolute_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _TeleportAbsolute_Response__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_turtlesim__srv__TeleportAbsolute_Response(&full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, turtlesim, srv, TeleportAbsolute_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, turtlesim, srv, TeleportAbsolute)() {
