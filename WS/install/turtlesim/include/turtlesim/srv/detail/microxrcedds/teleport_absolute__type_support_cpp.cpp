...
#include "turtlesim/srv/detail/teleport_absolute__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _TeleportAbsolute_Request__get_serialized_size_with_initial_alignment(
...
{
  bool full_bounded;
  return max_serialized_size_TeleportAbsolute_Request(&full_bounded, 0);
}
...
static message_type_support_callbacks_t _TeleportAbsolute_Request__callbacks = {
  ...
  _TeleportAbsolute_Request__get_serialized_size_with_initial_alignment,
...
{
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_TeleportAbsolute_Request__handle;
}
...
static size_t _TeleportAbsolute_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const turtlesim::srv::TeleportAbsolute_Response *>(
...
{
  bool full_bounded;
  return max_serialized_size_TeleportAbsolute_Response(&full_bounded, 0);
}
...
static message_type_support_callbacks_t _TeleportAbsolute_Response__callbacks = {
  ...
  _TeleportAbsolute_Response__get_serialized_size_with_initial_alignment,
...
{
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_TeleportAbsolute_Response__handle;
}
...
{
  return &turtlesim::srv::typesupport_microxrcedds_cpp::_TeleportAbsolute__handle;
}
