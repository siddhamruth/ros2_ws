...
{
  new (message_memory) tutorial_interfaces_cpp::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces_cpp::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[1] = {
  {
    ...
    offsetof(tutorial_interfaces_cpp::msg::Num, num),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Num_message_members = {
  ...
  "Num",  // message name
  1,  // number of fields
  sizeof(tutorial_interfaces_cpp::msg::Num),
...
{
  return &::tutorial_interfaces_cpp::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces_cpp, msg, Num)() {
  return &::tutorial_interfaces_cpp::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
