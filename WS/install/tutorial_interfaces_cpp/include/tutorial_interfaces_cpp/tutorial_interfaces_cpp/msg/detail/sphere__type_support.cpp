...
{
  new (message_memory) tutorial_interfaces_cpp::msg::Sphere(_init);
}

void Sphere_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces_cpp::msg::Sphere *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sphere_message_member_array[2] = {
  {
    ...
    offsetof(tutorial_interfaces_cpp::msg::Sphere, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces_cpp::msg::Sphere, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sphere_message_members = {
  "tutorial_interfaces_cpp::msg",  // message namespace
  "Sphere",  // message name
  2,  // number of fields
  sizeof(tutorial_interfaces_cpp::msg::Sphere),
...
{
  return &::tutorial_interfaces_cpp::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces_cpp, msg, Sphere)() {
  return &::tutorial_interfaces_cpp::msg::rosidl_typesupport_introspection_cpp::Sphere_message_type_support_handle;
}
